...
SHOW CREATE TABLE tbl_pessoa_pf;
SHOW INDEX FROM tbl_pessoa_pf WHERE Non_unique = 0;
...
CREATE TABLE tbl_endereco (
    ...
    uf                 ENUM('AC', 'AL', 'AP', 'AM', 'BA', 'CE', 'DF', 'ES', 'GO', 'MA', 'MT', 'MS', 'MG', 'PA', 'PB', 'PR', 'PE', 'PI', 'RJ', 'RN', 'RS', 'RO', 'RR', 'SC', 'SP', 'TO', 'SE') NOT NULL,
...
CREATE TABLE tbl_pagamento (
    ...
    forma_pagamento    ENUM('À VISTA', 'PARCELADO', 'PIX', 'BOLETO', 'CHEQUE', 'DINHEIRO') NOT NULL,
